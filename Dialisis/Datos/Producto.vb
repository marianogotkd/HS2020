...
#Region "procedimientos para form Gestion_Mercaderia_Alta"
    'me busca un producto dependiendo el proveedor
    Public Function Producto_buscarcod_en_proveedor(ByVal codinterno As String, ByVal Prov_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Producto_buscarcod_en_proveedor", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@prod_codigo", codinterno))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Prov_id", Prov_id))
        Dim ds_JE As New DataSet()
