...
#Region "Turno dialisis"

    Public Function Turnodialisis_alta(ByVal desc As String, ByVal desde_hora As String, ByVal desde_minutos As String, ByVal hasta_hora As String, ByVal hasta_minutos As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_alta", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_desc", desc))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_desde_hora", desde_hora))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_desde_minutos", desde_minutos))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_hasta_hora", hasta_hora))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_hasta_minutos", hasta_minutos))
    ...
    Public Function Dias_dialisis_alta(ByVal desc As String, ByVal turnodialisis_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Dias_dialisis_alta", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Dias_desc", desc))
    ...
    Public Function Turnodialisis_obtener_todo() As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_obtener_todo", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Dias_desc", desc))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", turnodialisis_id))
    ...
    Public Function Turnodialisis_obtener_dias(ByVal Turnodialisis_id As Integer) As DataSet
        ...
        Dim comando As New OleDbCommand("Turnodialisis_obtener_dias", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", turnodialisis_id))
    ...
    Public Function Turnodialisis_obtener_info(ByVal Turnodialisis_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_obtener_info", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
    ...
    Public Function Turnodialisis_modificar(ByVal Turnodialisis_id As Integer, ByVal desc As String, ByVal desde_hora As String, ByVal desde_minutos As String, ByVal hasta_hora As String, ByVal hasta_minutos As String) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_modificar", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_desc", desc))
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_desde_hora", desde_hora))
    ...
    Public Function Turnodialisis_eliminar_dias(ByVal Turnodialisis_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_eliminar_dias", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
    ...
    Public Function Turnodialisis_eliminar_turno(ByVal Turnodialisis_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Turnodialisis_eliminar_turno", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
    ...
    Public Function TurnoDialisis_consultar_inscriptos(ByVal Turnodialisis_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("TurnoDialisis_consultar_inscriptos", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", Turnodialisis_id))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", turnodialisis_id))
    ...
    Public Function TurnoDialisis_consultar_sesion(ByVal PAC_id As Integer, ByVal fecha As Date) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("TurnoDialisis_consultar_sesion", dbconn)
        comando.CommandType = CommandType.StoredProcedure
    ...
    Public Function TurnoDialisis_consultar_sesion_paciente(ByVal PAC_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("TurnoDialisis_consultar_sesion_paciente", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@PAC_id", PAC_id))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@fecha", fecha))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", turnodialisis_id))
    ...
    Public Function TurnoDialisis_consultar_sesion_paciente_presente(ByVal PAC_id As Integer) As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("TurnoDialisis_consultar_sesion_paciente_presente", dbconn)
        comando.CommandType = CommandType.StoredProcedure
        comando.Parameters.Add(New OleDb.OleDbParameter("@PAC_id", PAC_id))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@fecha", fecha))
        'comando.Parameters.Add(New OleDb.OleDbParameter("@Turnodialisis_id", turnodialisis_id))
