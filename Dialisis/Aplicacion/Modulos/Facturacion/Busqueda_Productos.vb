...
Public Class Busqueda_Productos
    ...
    Public Sub Obtener_Productos_Combos()
        ...
        Select Case form_procedencia
            ...
            Case "GM_Carga_Producto"
                'nota 27-08-2020 se va a recuperar productos de una sucursal y un proveedor determinado.
                ...
                ds_PROD = DAGestion_Mercaderia.Movimiento_Mercaderia_Alta_obtenertodo_carga(sucursal_id, Prov_id)
                If ds_PROD.Tables(1).Rows.Count <> 0 Then
                    'DataGridView1.DataSource = ds_PROD.Tables(1)
                    Venta_Caja_ds.Tables("Productos_Combos").Rows.Clear()
                    Venta_Caja_ds.Tables("Productos_Combos").Merge(ds_PROD.Tables(1))
    ...
    Public Sub LOAD_CARGA()
        ...
        'If form_procedencia = "GM_Carga_Producto" Then
        '    DataGridView1.Columns("ProdpreciovtaDataGridViewTextBoxColumn").Visible = False
        '    DataGridView1.Columns("prod_precio_vta_May").Visible = False
        '    DataGridView1.Columns("ProdstockDataGridViewTextBoxColumn").Visible = True
    ...
    Private Sub BO_agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BO_agregar.Click
        Select Case form_procedencia
            ...
            Case "GM_Carga_Producto"
                If DataGridView1.CurrentRow IsNot Nothing Then
                    Gestion_Mercaderia_Alta.tb_codint.Text = DataGridView1.CurrentRow.Cells(1).Value
                    Gestion_Mercaderia_Alta.tb_desc.Text = DataGridView1.CurrentRow.Cells(2).Value
                    Gestion_Mercaderia_Alta.tb_codint.Focus()
                    Gestion_Mercaderia_Alta.tb_codint.SelectAll()
                    Gestion_Mercaderia_Alta.Buscar_Cantidades(DataGridView1.CurrentRow.Cells(0).Value, Gestion_Mercaderia_Alta.cb_origen.SelectedValue, Gestion_Mercaderia_Alta.cb_destino.SelectedValue)

                    'If Gestion_Mercaderia_Alta.cb_Movimiento.Text = "Alta de Mercaderia" Then
                    Gestion_Mercaderia_Alta.Grupo_lote.Enabled = True
                    obtener_info_ultimo_lote(DataGridView1.CurrentRow.Cells(1).Value)
                    'End If
    ...
    Private Sub obtener_info_ultimo_lote(ByVal codint As Integer)
        ds_PROD = DAprod.Producto_buscarcod(codint)
        If ds_PROD.Tables(0).Rows.Count <> 0 Then
            Gestion_Mercaderia_Alta.tb_desc.Text = ds_PROD.Tables(0).Rows(0).Item("prod_descripcion")
            ...
            If ds_PROD.Tables(2).Rows.Count = 0 Then 'recupera el producto solo si tiene Lote = "SI"
                ...
                If ds_lotes.Tables(0).Rows.Count = 0 Then
                    ...
                    While i < Gestion_Mercaderia_Alta.DataGridView1.Rows.Count
                        If Gestion_Mercaderia_Alta.DataGridView1.Rows(i).Cells("CodprodDataGridViewTextBoxColumn").Value = Gestion_Mercaderia_Alta.tb_codint.Text Then
                            nrolote_de_bd = CInt(Gestion_Mercaderia_Alta.DataGridView1.Rows(i).Cells("Lote").Value)
                        End If
                        i = i + 1
                    End While
                    nrolote_de_bd = nrolote_de_bd + 1
                    Gestion_Mercaderia_Alta.txt_nrolote.Text = nrolote_de_bd
    ...
    Private Sub cb_categoria_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cb_categoria.SelectedIndexChanged
            ...
            If evento_load_completo = "si" Then
                If check_categoria.Checked = True Then
                    If check_marca.Checked = True Then
                        filtrar_solo_categoria_MoviAlta("")
                    Else
                        filtrar_solo_categoria_MoviAlta("sin marca")
                    End If
                ...
                Else
                    If check_marca.Checked = True Then
                        filtrar_solo_por_marca_MoviAlta()
                    Else
                        Obtener_Productos_Combos()
                    End If
                End If
        ...
        If form_procedencia = "Venta_Caja_gestion" Or form_procedencia = "Servicio_nuevo" Then
            If evento_load_completo = "si" Then
                If check_categoria.Checked = True Then
                    If check_marca.Checked = True Then
        ...
        If form_procedencia = "GM_Carga_Producto" Then
            If evento_load_completo = "si" Then
                If check_rubro.Checked = True Then
                    ...
                    If check_marca.Checked = True Then
                        filtrar_por_rubro_MovAlta("")
                    Else
                        filtrar_por_rubro_MovAlta("sin marca")
                    End If
        ...
        If form_procedencia = "GM_Carga_Producto" Then
            If evento_load_completo = "si" Then
                If check_subrubro.Checked = True Then
                    If check_marca.Checked = True Then
                        filtrar_por_subrubro_MovAlta("")
                    Else
                        filtrar_por_subrubro_MovAlta("sin marca")
                    End If
                Else
                    If check_marca.Checked = True Then
                        filtrar_por_rubro_MovAlta("")
    ...
    Private Sub check_marca_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles check_marca.CheckedChanged
        ...
        If form_procedencia = "Venta_Caja_gestion" Or form_procedencia = "Servicio_nuevo" Then '  "Pedido_Productos"
            If check_marca.Checked = True Then
                If cb_marca.Items.Count <> 0 Then
                    cb_marca.Enabled = True
                    check_categoria.Checked = False
...
#Region "filtrar para Movimientos alta"
    'nota: hago estos filtros teniendo en cuenta sucursal y PROVEEDOR, ya que las altas las hago siempre de uno determinado.
    Private Sub filtrar_solo_por_marca_MoviAlta()
        ds_prod_gestmerc = DAGestion_Mercaderia.Movimiento_Mercaderia_Alta_obtenerProducto_Combos_marca(sucursal_id, cb_marca.SelectedValue, Prov_id)
        Venta_Caja_ds.Tables("Productos_Combos").Rows.Clear()
        If ds_prod_gestmerc.Tables(0).Rows.Count <> 0 Then
            'si hay productos, voy a armar un dataset con los productos q realmente quiera mostrar.
            'tabla productos_combo
        ...
        End If
    End Sub
    Private Sub filtrar_solo_categoria_MoviAlta(ByVal filtro_descrip As String)
        Dim ds_productos As DataSet
        If filtro_descrip = "sin marca" Then
            ds_productos = DAGestion_Mercaderia.Movimiento_Mercaderia_Alta_obtenerProducto_Combos_categoria(sucursal_id, Prov_id)
        Else
            ds_productos = ds_prod_gestmerc
        End If
        ...
        End If
    End Sub
    Private Sub filtrar_por_rubro_MovAlta(ByVal filtro_descrip As String)
        Dim ds_productos As DataSet
        If filtro_descrip = "sin marca" Then
            ds_productos = DAGestion_Mercaderia.Movimiento_Mercaderia_Alta_obtenerProducto_Combos_categoria(sucursal_id, Prov_id)
        Else
        ...
        End If
    End Sub
    Private Sub filtrar_por_subrubro_MovAlta(ByVal filtro_descrip As String)
        Dim ds_productos As DataSet
        If filtro_descrip = "sin marca" Then
            ds_productos = DAGestion_Mercaderia.Movimiento_Mercaderia_Alta_obtenerProducto_Combos_categoria(sucursal_id, Prov_id)
        Else
...
#End Region
    ...
    Private Sub Busqueda_Productos_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        msj_esperar_sesiones.procedencia = "Busqueda_Productos_load"
