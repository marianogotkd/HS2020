Public Class Enfermeria_insumos_Ausente
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If filtro_guardado = "no" Then
            Dim result2 As Integer = MessageBox.Show("¿Desea registrar el uso del Filtro utilizado?", "Sistema de Gestión", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        ...
        If continuar_consumo = "si" Then
            Dim result3 As Integer = MessageBox.Show("¿Desea Consumir insumos listados?", "Sistema de Gestión", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
