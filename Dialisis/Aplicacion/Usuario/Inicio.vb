    ...
    Public Sub sesion()
        ...
        With ds_usu.Tables(0).Rows
            If .Count > 0 Then
                ...
                US_administrador.Label_Suc.Text = ds_usu.Tables(0).Rows(0).Item("sucursal_nombre")
                US_administrador.LB_USU_ape.Text = ds_usu.Tables(0).Rows(0).Item("USU_ape") + ", " + ds_usu.Tables(0).Rows(0).Item("USU_nom")
                US_administrador.LB_UT_dep.Text = ds_usu.Tables(0).Rows(0).Item("UT_desc")
                '-----directo a adm alla oculto lo que no me sirve----3/8/2020
                ...
                '---SACO las CAJAS PARA DIALISIS 3/8/2020---------
