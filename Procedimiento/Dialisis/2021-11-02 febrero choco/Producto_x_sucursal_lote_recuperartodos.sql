...
Producto.prod_contenido,
Producto_x_sucursal.ProdxSuc_stock_real,
Producto.prod_tipo      
                      
FROM                dbo.Producto_x_sucursal inner join dbo.Producto ON dbo.Producto_x_sucursal.prod_id = dbo.Producto.prod_id
                                             
where Producto_x_sucursal.prod_id = @prod_id and Producto_x_sucursal.sucursal_id = @sucursal_id
