...
#End Region
    ...
    Public Function Producto_x_Sucursal_obtener_todo_GLOBAL() As DataSet
        Try
            dbconn.Open()
        Catch ex As Exception
        End Try

        Dim comando As New OleDbCommand("Producto_x_Sucursal_obtener_todo_GLOBAL", dbconn)
        comando.CommandType = CommandType.StoredProcedure


        Dim ds_JE As New DataSet()
        Dim da_JE As New OleDbDataAdapter(comando)
        da_JE.Fill(ds_JE, "ProductoGLOBAL")
        dbconn.Close()
        Return ds_JE
    End Function
