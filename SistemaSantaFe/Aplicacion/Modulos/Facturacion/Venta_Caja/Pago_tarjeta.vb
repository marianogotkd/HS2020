Public Class Pago_tarjeta
        ...
        Else
            ...
            If tx_tarjeta.Text <> "" And tx_comprobante.Text <> "" Then
                If Venta_Caja_gestion.DataGridView1.Rows.Count <> 0 Then 'es la grilla de los productos agregados
                    ...
                    DAventa.Venta_x_tarjeta_alta(Venta_Caja_gestion.remito_ventaprod_id, CDec(tx_total.Text), tx_tarjeta.Text, tx_comprobante.Text)
        ...
        If form_procedencia = "Servicio_nuevo" Then
            ...
            Else
                ...
                If tx_tarjeta.Text <> "" And tx_comprobante.Text <> "" Then
                    ...
                    Dim venta_tipo_descripcion As String = "Servicio - pago tarjeta"
                    tipo_vta = "Cliente"
                    ...
                    Dim ds_Venta As DataSet = DAventa.VentaProducto_alta(CDec(tx_total.Text), Now, usuario_id, tipo_vta, cliente_id, CDec(tx_total.Text), 0, 0, 0, 0, venta_tipo_descripcion, Ser_id, vendedor_id, "Cobrado")
                    ...
                    Me.Close()
                Else
                    MessageBox.Show("Error, debe ingresar Tarjeta y Nº de Comprobante.", "Sistema de Gestión", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End If
        Else
                ...
                Else
                    ...
                    If tx_tarjeta.Text <> "" And tx_comprobante.Text <> "" Then
                        If Venta_Caja_gestion.DataGridView1.Rows.Count <> 0 Then 'es la grilla de los productos agregados
                            ...
                            'aqui llamo a la rutina que me muestra el reporte.
                            crear_reporte(ds_usuario, factura_id)
                            MessageBox.Show("La venta fue registrada correctamente.", "Sistema de Gestion.", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub crear_reporte(ByVal ds_usuario As DataSet, ByVal numerofactura As Integer)
        ...
        If Venta_Caja_gestion.lb_dni_clie.Text <> "- - - -" Then
            Dim dni As Integer = CInt(Venta_Caja_gestion.lb_dni_clie.Text)
