...
Public Class CR_orden_trabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplicacion.CR_orden_trabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_orden_trabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_orden_trabajo = New CR_orden_trabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
