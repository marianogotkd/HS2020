Public Class Caja
    ...
    Public Sub Caja_Validar()
        ...
        Else
            '///////17-12-2019/////////////////////
            Inicio.CAJA_id = ds_caja.Tables(0).Rows(0).Item("CAJA_id").ToString 'la busqueda en la bd siempre arroja una caja abierta para una terminal especifica y sucursal tambien.
            '/////////fin//////////////////////
